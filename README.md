...
- A README.md file documenting the work done and any assumptions made. See Report section.
...
See [CHALLENGE_REPORT.md](CHALLENGE_REPORT.md) for a detailed account of all work done, architecture decisions, and what was deferred.
