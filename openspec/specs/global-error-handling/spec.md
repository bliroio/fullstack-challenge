...
Provides a centralized Express error handler that returns safe, consistent JSON error responses while preventing internal details from leaking to clients.
